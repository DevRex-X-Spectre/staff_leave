...
/**
 * In-memory seed dataset for demo mode. Mirrors the schema in
 * supabase/migrations/001_initial_schema.sql so the same DAL
 * code paths work against both backends.
 *
 * The store is mutated in place by lib/mock/store.ts — see that
 * file for the mutation API.
 */
...
/** Default admin password (demo only). NEVER seed a real production password. */
export const seedUserPasswords: Record<string, string> = {
  'admin@naub.edu.ng': 'Admin@NAUB2026',
  'hod.cs@naub.edu.ng': 'Hod@NAUB2026',
  'hod.admin@naub.edu.ng': 'Hod@NAUB2026',
  'hod.registry@naub.edu.ng': 'Hod@NAUB2026',
  'hr@naub.edu.ng': 'Hr@NAUB2026',
  'staff1@naub.edu.ng': 'Staff@NAUB2026',
  'staff2@naub.edu.ng': 'Staff@NAUB2026',
  'staff3@naub.edu.ng': 'Staff@NAUB2026',
};
...
export const leaveTypes: LeaveType[] = [
  {
    ...
    name: 'Annual Leave',
    applicable_to: 'both',
    max_days_academic: 21,
    max_days_non_academic: 21,
  ...
  },
  {
    ...
    name: 'Sick Leave',
    applicable_to: 'both',
    max_days_academic: 14,
    max_days_non_academic: 14,
  ...
  },
  {
    ...
    applicable_to: 'non_academic',
    max_days_academic: null,
    max_days_non_academic: 90,
    requires_document: true,
    is_active: true,
    created_at: '2026-01-01T08:00:00Z',
  },
  ...
  },
  {
    id: 'lt-study',
    name: 'Study Leave',
    applicable_to: 'academic',
    max_days_academic: 365,
    max_days_non_academic: null,
    requires_document: true,
    is_active: true,
    created_at: '2026-01-01T08:00:00Z',
  },
...
/** Per-user annual entitlements for the current year. */
...
export const leaveRotas: LeaveRota[] = [
  {
    id: 'rota-1',
    department_id: 'dept-cs',
    title: 'Q3 2026 Departmental Rota',
    period_start: '2026-07-01',
    period_end: '2026-09-30',
    max_concurrent: 2,
    published_by: 'user-hod-cs',
    published_at: '2026-06-15T10:00:00Z',
    notes: 'Maximum of 2 staff on leave at any time during the quarter.',
  },
];

export const rotaSlots: RotaSlot[] = [
...
export const userApprovalRequests: UserApprovalRequest[] = [
  {
    id: 'uar-1',
    user_id: 'user-staff-pending',
    requested_role: 'staff',
    requested_department_id: 'dept-cs',
    status: 'pending',
    admin_comment: null,
    reviewed_by: null,
    reviewed_at: null,
