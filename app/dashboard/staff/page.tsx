...
import { getLeaveBalances, listApplicationsByUser } from '@/lib/data/dal';
import { PageHeader, StatCard, ProgressBar } from '@/components/ui/stat-card';
  ...
  return (
    <div className="animate-fade-in">
      <PageHeader
        ...
        description={user.department_id ? `Department: ${user.department_id}` : undefined}
        actions={
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[var(--border-subtle)]">
                  <th className="text-left py-2.5 text-[11px] font-semibold uppercase tracking-widest text-[var(--text-tertiary)] pb-3">
                    Leave type
                  </th>
                  <th className="text-left py-2.5 text-[11px] font-semibold uppercase tracking-widest text-[var(--text-tertiary)] pb-3">
                    Dates
